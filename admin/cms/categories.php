...
var url= "../controller/categories.php";
...
<div class="row">
        <div class="large-12 columns">
          <h1 class="header"><a href="">Categories</a></h1>

            <div class="subheader">
            <a href="categories_m.php"><button class="button icon-plus-circle" >Add new Record</button></a>
            </div>
 ...
 foreach ($data as $row){?>
	<tr class="row<?php echo $k;?>" id="<?php echo $row['id'];?>">
    	<td ><?php echo $row['id']; ?>	</td>
         <td><a href="categories_m.php?id=<?php echo $row['id'];?>"><?php  echo $row['cat_name'] ; ?></a> </td>
         <td><?php  echo $row['cat_description'] ; ?></td>
         <td width="8%" align="center">
         <a href="categories_m.php?id=<?php echo $row['id'];?>"><span class="icon-edit"></span></a> 
